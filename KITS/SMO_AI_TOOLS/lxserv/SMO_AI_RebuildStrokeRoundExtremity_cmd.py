...
Command_Name = "smo.AI.RebuildStroke"

class SMO_AI_RebuildStrokeRoundExtremity_Cmd(lxu.command.BasicCommand):
    def __init__(self):
    ...
    def basic_Execute(self, msg, flags):
        IntBuildMode = self.dyna_Int (0)
        IntTriRadial_Mode = self.dyna_Int (1)
        IntUser_Mode = self.dyna_Int (2)
        IntSideCount = self.dyna_Int (3)
        ...
        ####### SAFETY CHECK 3 #######
        ##############################
        #####--------------------  safety check 3: at Least 1 Vertex are selected --- START --------------------#####
        if CsVert < 3:
        ...
        #####--------------------  safety check 3: at Least 3 Vertex are selected --- END --------------------#####
...
lx.bless(SMO_AI_RebuildStrokeRoundExtremity_Cmd, Command_Name)