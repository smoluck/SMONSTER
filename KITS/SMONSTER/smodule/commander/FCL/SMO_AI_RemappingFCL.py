...
FORMS = [
    {
        "label": "SMO AI TOOLS Pie Menu",
        "recommended": "ctrl-alt-k",
        "cmd": "attr.formPopover {SMO_AI_TOOLS_PM:sheet}"
    }
...
class SMO_AI_TOOLS_KeymapCmdListClass(lxifc.UIValueHints):
...
class SMO_AI_KeymapCmdClass(lxu.command.BasicCommand):
    def __init__(self):
