# python
"""
# Name:         SMO_SET_RotatePoly_PreserveChild.py
# Version:      1.0
#
# Purpose:      Select the mesh to rotate, in item mode.
# It will rotate by 180 degree the polygons, while rotating the center as opposed,
# and preserve the child orientation and parent ing of this item.
#
...
if TotalSafetyCheck == TotalSafetyCheckTrueValue:
	...
	lx.eval('@{kit_SMO_GAME_CONTENT:MacroSmoluck/Setup/SMO_SET_RotateXYZ_Item.LXM} 180 0 180')
