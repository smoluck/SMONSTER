...
Purpose:		This script is designed to:
                This script is designed to move Center and rotate Center
...
TotalSafetyCheck = (
        SMO_SafetyCheck_Only1MeshItemSelected + SMO_SafetyCheck_PolygonModeEnabled + SMO_SafetyCheck_EdgeModeEnabled + SMO_SafetyCheck_VertexModeEnabled)
