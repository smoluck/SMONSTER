# python
"""
Name:           SMO_ExportMeshOpRig_to_FBXSequence_TRIPLE_AUDIO.py

Purpose:        This script is designed to:
                Test Export MeshOps rig as a freezed Mesh, over time,
                as an FBX sequence. Select the MeshOp item and run.
...
# @kit_SMO_GAME_CONTENT:MacroSmoluck/Meshops/SMO_MES_ExportMeshOpRig_to_FBXSequence_TRIPLE_AUDIO.py
...
lx.eval('@{kit_SMO_GAME_CONTENT:MacroSmoluck/Meshops/SMO_MES_ExportMeshOpRig_to_FBXSequence_TRIPLE.py}')
