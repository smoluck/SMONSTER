...
class SMO_ArrayTarget_Cmd(lxu.command.BasicCommand):
    ...
    def basic_Enable(self, msg):
        ...
        try:
            ...
            if FilesToLoad:
                lx.eval(
                    'loaderOptions.fbx false true true true false false true false false false false false false false false FBXAnimSampleRate_x1 1.0 defaultimport')
        ...
        try:
            ...
            lx.eval(
                "user.def MatchName username {Enter the Pattern name of your current Reference Target (FBX filename)}")
