...
class SMO_MARMOSET_LIVELINK_AutoSegmentedExport_Cmd (lxu.command.BasicCommand):
    ...
    def valid_MarmosetToolbagExePath (self, marmosettoolbag_exe_path):
        return ((marmosettoolbag_exe_path != None) and os.path.lexists (marmosettoolbag_exe_path) and (os.path.splitext (marmosettoolbag_exe_path)[1].lower () == '.exe'))
    ...
    def basic_Execute (self, msg, flags):
        ...
        if Smo_MarmosetToolbagVersion == 0 :
            HardCoded_TBScene_Path = lx.eval('query platformservice alias ? {kit_SMO_MARMOSET_LIVELINK:MarmosetToolbag_Scene_Template/MarmosetToolbag_v3_Scene_Template.tbscene}')
            # print HardCoded_TBScene_Path
        if Smo_MarmosetToolbagVersion == 1 :
            HardCoded_TBScene_Path = lx.eval('query platformservice alias ? {kit_SMO_MARMOSET_LIVELINK:MarmosetToolbag_Scene_Template/MarmosetToolbag_v4_Scene_Template.tbscene}')
            # print HardCoded_TBScene_Path
        ...
        ################   MarmosetToolbag Python Script   #################
        if Smo_MarmosetToolbagVersion == 0 :
            HardCoded_Script_Path = lx.eval('query platformservice alias ? {kit_SMO_MARMOSET_LIVELINK:Marmoset_Script/SMO_AutoImporter_V3.py}')
            # print HardCoded_Script_Path
        if Smo_MarmosetToolbagVersion == 1 :
            HardCoded_Script_Path = lx.eval('query platformservice alias ? {kit_SMO_MARMOSET_LIVELINK:Marmoset_Script/SMO_AutoImporter_V4.py}')
            # print HardCoded_Script_Path
        ...
        if Smo_MarmosetToolbag_AO == 1 :
            ...
            #lx.eval('clip.new')
            if MapSize == 512 :
                lx.eval('clip.newStill "{}" x512 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_AO))
            if MapSize == 1024 :
                lx.eval('clip.newStill "{}" x1024 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_AO))
            if MapSize == 2048 :
                lx.eval('clip.newStill "{}" x2048 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_AO))
            if MapSize == 4096 :
                lx.eval('clip.newStill "{}" x4096 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_AO))
            ...
            lx.eval('select.subItem %s remove ;render;environment;mediaClip;scene;camera;light;locator;bake;textureLayer' % PolyRender)
            ...
            if Smo_MarmosetToolbag_AO == False :
        ...
        if Smo_MarmosetToolbag_AOF == 1 :
            ...
            if MapSize == 512:
                lx.eval(
                    'clip.newStill "{}" x512 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_AOF))
            if MapSize == 1024:
                lx.eval(
                    'clip.newStill "{}" x1024 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_AOF))
            if MapSize == 2048:
                lx.eval(
                    'clip.newStill "{}" x2048 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_AOF))
            if MapSize == 4096:
                lx.eval(
                    'clip.newStill "{}" x4096 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_AOF))
            ...
            if Smo_MarmosetToolbag_AOF == True:
                lx.eval('item.channel textureLayer$enable true')
            if Smo_MarmosetToolbag_AOF == False:
                lx.eval('item.channel textureLayer$enable false')
        ################################################
        ...
        if Smo_MarmosetToolbag_TSNRM == 1 :
            ...
            #lx.eval('clip.new')
            if MapSize == 512 :
                lx.eval('clip.newStill "{}" x512 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_TSNRM))
            if MapSize == 1024 :
                lx.eval('clip.newStill "{}" x1024 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_TSNRM))
            if MapSize == 2048 :
                lx.eval('clip.newStill "{}" x2048 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_TSNRM))
            if MapSize == 4096 :
                lx.eval('clip.newStill "{}" x4096 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_TSNRM))
            ...
            if Smo_MarmosetToolbag_TSNRM == True :
                lx.eval('item.channel textureLayer$enable true')
            if Smo_MarmosetToolbag_TSNRM == False :
                lx.eval('item.channel textureLayer$enable false')
        ################################################
        ...
        if Smo_MarmosetToolbag_OSNRM == 1 :
            ...
            #lx.eval('clip.new')
            if MapSize == 512 :
                lx.eval('clip.newStill "{}" x512 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_OSNRM))
            if MapSize == 1024 :
                lx.eval('clip.newStill "{}" x1024 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_OSNRM))
            if MapSize == 2048 :
                lx.eval('clip.newStill "{}" x2048 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_OSNRM))
            if MapSize == 4096 :
                lx.eval('clip.newStill "{}" x4096 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_OSNRM))
            ...
            if Smo_MarmosetToolbag_OSNRM == True :
                lx.eval('item.channel textureLayer$enable true')
            if Smo_MarmosetToolbag_OSNRM == False :
                lx.eval('item.channel textureLayer$enable false')
        ################################################
        ...
        if Smo_MarmosetToolbag_POS == 1 :
            ...
            #lx.eval('clip.new')
            if MapSize == 512 :
                lx.eval('clip.newStill "{}" x512 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_POS))
            if MapSize == 1024 :
                lx.eval('clip.newStill "{}" x1024 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_POS))
            if MapSize == 2048 :
                lx.eval('clip.newStill "{}" x2048 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_POS))
            if MapSize == 4096 :
                lx.eval('clip.newStill "{}" x4096 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_POS))
            ...
            if Smo_MarmosetToolbag_POS == True :
                lx.eval('item.channel textureLayer$enable true')
            if Smo_MarmosetToolbag_POS == False :
                lx.eval('item.channel textureLayer$enable false')
        ################################################
        ...
        if Smo_MarmosetToolbag_CUR == 1 :
            ...
            #lx.eval('clip.new')
            if MapSize == 512 :
                lx.eval('clip.newStill "{}" x512 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_CUR))
            if MapSize == 1024 :
                lx.eval('clip.newStill "{}" x1024 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_CUR))
            if MapSize == 2048 :
                lx.eval('clip.newStill "{}" x2048 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_CUR))
            if MapSize == 4096 :
                lx.eval('clip.newStill "{}" x4096 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_CUR))
            ...
            if Smo_MarmosetToolbag_CUR == True :
                lx.eval('item.channel textureLayer$enable true')
            if Smo_MarmosetToolbag_CUR == False :
                lx.eval('item.channel textureLayer$enable false')
        ################################################
        ...
        if Smo_MarmosetToolbag_OBJID == 1 :
            ...
            #lx.eval('clip.new')
            if MapSize == 512 :
                lx.eval('clip.newStill "{}" x512 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_OBJID))
            if MapSize == 1024 :
                lx.eval('clip.newStill "{}" x1024 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_OBJID))
            if MapSize == 2048 :
                lx.eval('clip.newStill "{}" x2048 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_OBJID))
            if MapSize == 4096 :
                lx.eval('clip.newStill "{}" x4096 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_OBJID))
            ...
            if Smo_MarmosetToolbag_OBJID == True :
                lx.eval('item.channel textureLayer$enable true')
            if Smo_MarmosetToolbag_OBJID == False :
                lx.eval('item.channel textureLayer$enable false')
        ################################################
        ...
        if Smo_MarmosetToolbag_THI == 1 :
            ...
            #lx.eval('clip.new')
            if MapSize == 512 :
                lx.eval('clip.newStill "{}" x512 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_THI))
            if MapSize == 1024 :
                lx.eval('clip.newStill "{}" x1024 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_THI))
            if MapSize == 2048 :
                lx.eval('clip.newStill "{}" x2048 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_THI))
            if MapSize == 4096 :
                lx.eval('clip.newStill "{}" x4096 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_THI))
            ...
            if Smo_MarmosetToolbag_THI == True :
                lx.eval('item.channel textureLayer$enable true')
            if Smo_MarmosetToolbag_THI == False :
                lx.eval('item.channel textureLayer$enable false')
        ################################################
        ...
        if Smo_MarmosetToolbag_MATID == 1 :
            ...
            if MapSize == 512:
                lx.eval(
                    'clip.newStill "{}" x512 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_MATID))
            if MapSize == 1024:
                lx.eval(
                    'clip.newStill "{}" x1024 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_MATID))
            if MapSize == 2048:
                lx.eval(
                    'clip.newStill "{}" x2048 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_MATID))
            if MapSize == 4096:
                lx.eval(
                    'clip.newStill "{}" x4096 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_MATID))
            ...
            if Smo_MarmosetToolbag_MATID == True:
                lx.eval('item.channel textureLayer$enable true')
            if Smo_MarmosetToolbag_MATID == False:
                lx.eval('item.channel textureLayer$enable false')
        ################################################
        ...
        if Smo_MarmosetToolbag_ALBEDO == 1 :
            ...
            if Smo_Marmoset_ScenePathSubfolder == 1:
                # builds the complete path out of the SceneFolder
                image_export_path_ALBEDO = os.path.join(OutputFolder, SMO_Marmoset_LL_FolderName, image_file_name_ALBEDO)
            if Smo_Marmoset_ScenePathSubfolder == 0:
                # builds the complete path out of the temp dir and the temp file name
            ...
            if MapSize == 512:
                lx.eval(
                    'clip.newStill "{}" x512 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_ALBEDO))
            if MapSize == 1024:
                lx.eval(
                    'clip.newStill "{}" x1024 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_ALBEDO))
            if MapSize == 2048:
                lx.eval(
                    'clip.newStill "{}" x2048 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_ALBEDO))
            if MapSize == 4096:
                lx.eval(
                    'clip.newStill "{}" x4096 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_ALBEDO))
            ...
            if Smo_MarmosetToolbag_ALBEDO == True:
                lx.eval('item.channel textureLayer$enable true')
            if Smo_MarmosetToolbag_ALBEDO == False:
                lx.eval('item.channel textureLayer$enable false')
        ################################################
        ...
        if Smo_MarmosetToolbag_UVID == 1 :
            ...
            if MapSize == 512:
                lx.eval(
                    'clip.newStill "{}" x512 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_UVID))
            if MapSize == 1024:
                lx.eval(
                    'clip.newStill "{}" x1024 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_UVID))
            if MapSize == 2048:
                lx.eval(
                    'clip.newStill "{}" x2048 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_UVID))
            if MapSize == 4096:
                lx.eval(
                    'clip.newStill "{}" x4096 RGBA false false format:PSD colorspace:(none)'.format(image_export_path_UVID))
            ...
            if Smo_MarmosetToolbag_UVID == True:
                lx.eval('item.channel textureLayer$enable true')
            if Smo_MarmosetToolbag_UVID == False:
                lx.eval('item.channel textureLayer$enable false')
        ################################################
        ...
        Data = {'ScenePathSubfolder' : Smo_Marmoset_ScenePathSubfolder, 'BaseBakeFilePath' : BaseBakeFilePath, 'BaseBakeFileName' : BaseBakeFileName, 'SceneName' : SceneName, 'DataExchangeFileName' : DataExchangeFileName, 'DataExchangeFilePath' : DataExchangeFilePath, 'MapSize' : MapSize, 'ImgFileFrmt' : ImgFileFrmt, 'SeparatorStr' : SeparatorStr, 'OutputFolder' : OutputFolder, 'Lowpoly NameTag' : NameTagLP, 'Cage NameTag' : NameTagCage, 'Highpoly NameTag' : NameTagHP, 'Lowpoly FBX Filename' : fbx_file_name_LP, 'Cage FBX Filename' : fbx_file_name_Cage, 'Highpoly FBX Filename' : fbx_file_name_HP, 'Lowpoly FBX FilePath' : fbx_export_path_LP, 'Cage FBX FilePath' : fbx_export_path_Cage, 'Highpoly FBX FilePath' : fbx_export_path_HP, 'AO State' : Smo_MarmosetToolbag_AO, 'AOF State' : Smo_MarmosetToolbag_AOF, 'TSNRM State' : Smo_MarmosetToolbag_TSNRM, 'OSNRM State' : Smo_MarmosetToolbag_OSNRM, 'POS State' : Smo_MarmosetToolbag_POS, 'CUR State' : Smo_MarmosetToolbag_CUR, 'OBJID State' : Smo_MarmosetToolbag_OBJID, 'THI State' : Smo_MarmosetToolbag_THI, 'MATID State' : Smo_MarmosetToolbag_MATID, 'ALBEDO State' : Smo_MarmosetToolbag_ALBEDO, 'UVID State' : Smo_MarmosetToolbag_UVID, 'AO NameTag' : TagImg_AO, 'AOF NameTag' : TagImg_AOF, 'TSNRM NameTag' : TagImg_TSNRM, 'OSNRM NameTag' : TagImg_OSNRM, 'POS NameTag' : TagImg_POS, 'CUR NameTag' : TagImg_CUR, 'OBJID NameTag' : TagImg_OBJID, 'THI NameTag' : TagImg_THI, 'MATID NameTag' : TagImg_MATID, 'ALBEDO NameTag' : TagImg_ALBEDO, 'UVID NameTag' : TagImg_UVID, 'AO Filename' : image_file_name_AO, 'AOF Filename' : image_file_name_AOF, 'TSNRM Filename' : image_file_name_TSNRM, 'OSNRM Filename' : image_file_name_OSNRM, 'POS Filename' : image_file_name_POS, 'CUR Filename' : image_file_name_CUR, 'OBJID Filename' : image_file_name_OBJID, 'THI Filename' : image_file_name_THI, 'MATID Filename' : image_file_name_MATID, 'ALBEDO Filename' : image_file_name_ALBEDO, 'UVID Filename' : image_file_name_UVID, 'AO FilePath' : image_export_path_AO, 'AOF FilePath' : image_export_path_AOF, 'TSNRM FilePath' : image_export_path_TSNRM, 'OSNRM FilePath' : image_export_path_OSNRM, 'POS FilePath' : image_export_path_POS, 'CUR FilePath' : image_export_path_CUR, 'OBJID FilePath' : image_export_path_OBJID, 'THI FilePath' : image_export_path_THI, 'MATID FilePath' : image_export_path_MATID, 'ALBEDO FilePath' : image_export_path_ALBEDO, 'UVID FilePath' : image_export_path_UVID, 'AutoSaveMarmoSceneFile' : Bool_AutoSaveMarmoSceneFile, 'AutoBakeAtLoad' : Bool_AutoBakeAtLoad, 'AutoCloseMarmo' : Bool_AutoCloseMarmo, 'NRM_FlipX' : Bool_NRMFlipX, 'NRM_FlipY' : Bool_NRMFlipY, 'NRM_FlipZ' : Bool_NRMFlipZ, 'PerPixelSample' : PerPxSampleCount, 'RaysSampleCount' : RaysSampleCount}
        ...
        # Call MarmosetToolbag.
        if LoadViaPythonMode == False :
            proc = subprocess.Popen([Smo_MarmosetToolbagExe_AbsPath, " ", Smo_MarmosetToolbagTemplateScene_AbsPath], executable=Smo_MarmosetToolbagExe_AbsPath, stdout=subprocess.PIPE)
            stdout, stderr = proc.communicate()
            rc = proc.returncode

        if LoadViaPythonMode == True :
            proc = subprocess.Popen([Smo_MarmosetToolbagExe_AbsPath, " ", Smo_MarmosetToolbagScript_AbsPath], executable=Smo_MarmosetToolbagExe_AbsPath, stdout=subprocess.PIPE)
            stdout, stderr = proc.communicate()
            rc = proc.returncode
