...
SMO_RIZOMUV_LIVELINK_HOTKEYS = [
    {
        "contexts": [
            [".global", "(stateless)", ".anywhere", "(contextless)", "attr.formPopover {SMO_LL_MARMOSET_PM_SH:sheet}"]
        ],
        "key": "ctrl-alt-shift-m",
        "command": "attr.formPopover {SMO_LL_MARMOSET_PM_SH:sheet}",
        "name": "MARMOSET TOOLBAG LiveLink: Popover Menu",
        "info": "Ctrl Alt Shift M"
    }
...
class SMO_MARMOSET_LIVELINK_KeymapCmdClass(SmoCommanderClass):
...
lx.bless(SMO_MARMOSET_LIVELINK_KeymapCmdClass, "smo.LL.MARMOSET.MapDefaultHotkeys")


class RemoveSMO_MARMOSET_LIVELINK_KeymapCmdClass(SmoCommanderClass):
    ...
    def commander_execute(self, msg, flags):
        ...
        modo.dialogs.alert("Reverted SMO MARMOSET LiveLink Hotkeys", "Reverted %s SMO MARMOSET LiveLink hotkeys to defaults." % len(SMO_RIZOMUV_LIVELINK_HOTKEYS))

lx.bless(RemoveSMO_MARMOSET_LIVELINK_KeymapCmdClass, "smo.LL.MARMOSET.UnmapDefaultHotkeys")


class ClearSMO_MARMOSET_LIVELINK_KeymapCmdClass(SmoCommanderClass):
