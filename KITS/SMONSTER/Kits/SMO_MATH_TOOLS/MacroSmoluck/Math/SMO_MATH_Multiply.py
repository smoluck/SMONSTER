# python
"""
# Name:         SMO_MES_Add_MultiplyNode.py
# Version: 1.0
#
# Purpose: Add a divide node to the current link and divide it by 2 by default.
#
...
###################################
try:
    lx.eval('modifier.create "cmMathBasic:mul" insert:true')
    lx.eval('item.channel cmMathBasic$input2 1.0')
