# python
"""
# Name:         SMO_MATH_Const_GoldenRatio.py
# Version: 1.0
#
# Purpose: Add a Golden Ratio node.
#
...
###################################
try:
    lx.eval('modifier.create cmConstant insert:true')
    lx.eval('item.channel cmConstant$constant golden')
