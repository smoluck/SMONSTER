...
lx.eval('user.value SMO_UseVal_BATCH_String_Line003 {smo.GC.RenameMeshesBySceneName}')
lx.eval('user.value SMO_UseVal_BATCH_String_Line004 {select.itemType mesh}')
lx.eval('user.value SMO_UseVal_BATCH_String_Line005 {layer.unmergeMeshes}')
