#python
#---------------------------------------
# Name:         SMO_Bool_AxisDrill_Z_Stencil.py
# Version: 1.0
#
# Purpose: This script is designed Axis Drill on Z in Stencil Mode
...
if TotalSafetyCheck == TotalSafetyCheckTrueValue:
	...
	## <----( Main Command )----> 
	##############################
	# replay name:"AxisDrill Action on Z"
	lx.eval('poly.drill mode:Stencil axis:Z material:Default cutmesh:background')
	##############################
	## <----( Main Command )----> 
	##############################
...
lx.out('End of SMO_Bool_AxisDrill_Z_Stencil Script')
