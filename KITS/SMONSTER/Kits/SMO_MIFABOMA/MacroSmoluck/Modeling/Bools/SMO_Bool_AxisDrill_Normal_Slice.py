#python
#---------------------------------------
# Name:         SMO_Bool_AxisDrill_Normal_Slice.py
# Version: 1.0
#
# Purpose: This script is designed Axis Drill in Slice Mode
...
if TotalSafetyCheck == TotalSafetyCheckTrueValue:
	...
	lx.eval('poly.drill mode:Slice axis:Y material:Default cutmesh:background')
	##############################
	## <----( Main Command )----> 
	##############################
...
lx.out('End of SMO_Bool_AxisDrill_Normal_Slice Script')
