#python
#---------------------------------------
# Name:         SMO_Bool_SolidDrill_Core.py
# Version: 1.0
#
# Purpose: This script is designed Solid Drill in Core Mode
...
if TotalSafetyCheck == TotalSafetyCheckTrueValue:
	...
	## <----( Main Command )----> 
	##############################
	# replay name:"SolidDrill Core Action"
	lx.eval('poly.solidDrill Core Default background')
	##############################
	## <----( Main Command )----> 
	##############################
...
lx.out('End of SMO_Bool_SolidDrill_Core Script')
