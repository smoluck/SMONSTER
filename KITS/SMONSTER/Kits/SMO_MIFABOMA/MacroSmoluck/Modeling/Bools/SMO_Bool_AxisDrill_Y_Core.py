#python
#---------------------------------------
# Name:         SMO_Bool_AxisDrill_Y_Core.py
# Version: 1.0
#
# Purpose: This script is designed Axis Drill on Y in Core Mode
...
if TotalSafetyCheck == TotalSafetyCheckTrueValue:
	...
	lx.eval('poly.drill mode:Core axis:Y material:Default cutmesh:background')
	##############################
	## <----( Main Command )----> 
	##############################
...
lx.out('End of SMO_Bool_AxisDrill_Y_Core Script')
