#python
#---------------------------------------
# Name:         SMO_Bool_AxisDrill_Z_Tunnel.py
# Version: 1.0
#
# Purpose: This script is designed Axis Drill on Z in Tunnel Mode
...
if TotalSafetyCheck == TotalSafetyCheckTrueValue:
	...
	lx.eval('poly.drill mode:tunnel axis:Z material:Default cutmesh:background')
	##############################
	## <----( Main Command )----> 
	##############################
...
lx.out('End of SMO_Bool_AxisDrill_Z_Tunnel Script')
