#python
#---------------------------------------
# Name:         SMO_Bool_AxisDrill_Normal_Tunnel.py
# Version: 1.0
#
# Purpose: This script is designed Axis Drill in Tunnel Mode
...
if TotalSafetyCheck == TotalSafetyCheckTrueValue:
	...
	## <----( Main Command )----> 
	##############################
	# replay name:"AxisDrill Action on Y (With Worplane Activated, so using Polygon normal)"
	lx.eval('poly.drill mode:Tunnel axis:Y material:Default cutmesh:background')
	##############################
	## <----( Main Command )----> 
	##############################
...
lx.out('End of SMO_Bool_AxisDrill_Normal_Tunnel Script')
