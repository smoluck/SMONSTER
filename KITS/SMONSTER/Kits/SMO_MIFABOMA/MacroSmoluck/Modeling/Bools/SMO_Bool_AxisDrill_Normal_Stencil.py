# python
"""
Name:         	SMO_Bool_AxisDrill_Normal_Stencil.py

Purpose: 		This script is designed Axis to:
                Drill in Stencil Mode the last Polygon Selection
...
lx.out('End of SMO_Bool_AxisDrill_Normal_Stencil Script')
