# python
"""
# Name:         SMO_Bool_AxisDrill_X_Stencil.py
# Version: 1.0
#
# Purpose: This script is designed Axis Drill on X in Stencil Mode
...
if TotalSafetyCheck == TotalSafetyCheckTrueValue:
	...
	# <----( Main Command )----> 
	# -------------------------- #
	# replay name:"AxisDrill Action on X"
	lx.eval('poly.drill mode:Stencil axis:X material:Default cutmesh:background')
	# -------------------------- #
	# <----( Main Command )----> 
	# -------------------------- #
...
lx.out('End of SMO_Bool_AxisDrill_X_Stencil Script')
