#python
#---------------------------------------
# Name:         SMO_Bool_SolidDrill_Stencil.py
# Version: 1.0
#
# Purpose: This script is designed Solid Drill in Stencil Mode
# using the last Polygon Selection (Connected Polys)
...
if TotalSafetyCheck == TotalSafetyCheckTrueValue:
	...
	## <----( Main Command )----> 
	##############################
	# replay name:"SolidDrill Stencil Action"
	lx.eval('poly.solidDrill Stencil Default background')
	##############################
	## <----( Main Command )----> 
	##############################
...
lx.out('End of SMO_Bool_SolidDrill_Stencil Script')
