# python
"""
# Name:         SMO_Bool_SolidDrill_Slice.py
# Version: 1.0
#
# Purpose: This script is designed Solid Drill in Slice Mode
...
if TotalSafetyCheck == TotalSafetyCheckTrueValue:
	...
	# <----( Main Command )---->
	# -------------------------- #
	# replay name:"SolidDrill Slice Action"
	lx.eval('poly.solidDrill Slice Default background')
	# -------------------------- #
	# <----( Main Command )---->
	# -------------------------- #
...
lx.out('End of SMO_Bool_SolidDrill_Slice Script')
