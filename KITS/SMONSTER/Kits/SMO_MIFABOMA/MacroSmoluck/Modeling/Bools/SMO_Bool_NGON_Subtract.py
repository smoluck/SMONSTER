...
if TotalSafetyCheck == TotalSafetyCheckTrueValue:
    ...
    lx.eval('select.type item')
    lx.eval('select.drop item')
    lx.eval('select.useSet TARGET select')
    ...
    lx.eval('select.editSet name:TARGET_EDGES_BOOLNGON_Tag mode:add')
    ...
    lx.eval('select.type edge')
    lx.eval('select.all')
    lx.eval('select.editSet name:SOURCE_EDGES_BOOLNGON_Tag mode:add')
    lx.eval('select.drop edge')
    lx.eval('select.type item')
    lx.eval('select.drop item')
    ...
    lx.eval('select.editSet name:Intersect_Edge_Boundary mode:add')
    lx.eval('select.drop edge')
    lx.eval('select.type polygon')
    lx.eval('select.drop polygon')
    ...
    lx.eval('select.useSet Intersection_TriTag select')
    lx.eval('script.run "macro.scriptservice:92663570022:macro"')
    lx.eval('select.editSet BOOLNGON_BoundaryEdge add {}')
    lx.eval('select.drop edge')
    lx.eval('select.type polygon')
    lx.eval('select.useSet Intersection_TriTag select')
    lx.eval('select.convert edge')
    lx.eval('select.useSet BOOLNGON_BoundaryEdge deselect')
    lx.eval('!delete')
    ...
    lx.eval('!vert.merge fixed dist:0.00001 disco:false')
    ...
    # Delete Selection Set on Poly and Edges
    lx.eval('select.drop polygon')
    lx.eval('!select.deleteSet Intersection_TriTag')
    lx.eval('select.type edge')
    lx.eval('!select.deleteSet Intersect_Edge_Boundary')
    lx.eval('!select.deleteSet BOOLNGON_BoundaryEdge')
