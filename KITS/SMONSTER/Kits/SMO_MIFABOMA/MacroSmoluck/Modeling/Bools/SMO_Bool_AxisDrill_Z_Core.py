# python
"""
# Name:         SMO_Bool_AxisDrill_Z_Core.py
# Version: 1.0
#
# Purpose: This script is designed Axis Drill on Z in Core Mode
...
if TotalSafetyCheck == TotalSafetyCheckTrueValue:
	...
	lx.eval('poly.drill mode:core axis:Z material:Default cutmesh:background')
	# -------------------------- #
	# <----( Main Command )---->
	# -------------------------- #
...
lx.out('End of SMO_Bool_AxisDrill_Z_Core Script')
