...
class SMO_UV_UnwrapPlanar_Cmd(lxu.command.BasicCommand):
    ...
    def basic_Execute(self, msg, flags):
        ...
        UVUnwrapPlanar_UVMapName = lx.eval('user.value SMO_UV_SelectedMeshUVmapName ?')
        ...
        TotalSafetyCheck = (SMO_SafetyCheck_Only1MeshItemSelected + SMO_SafetyCheck_UVUnwrapPlanar_PolygonModeEnabled + SMO_SafetyCheck_UVUnwrapPlanar_min1PolygonSelected)
        ...
        ## <----( Main Macro : )----> ##
        ################################
        if SMO_SafetyCheck_UVUnwrapPlanar_UVMapCount == True :
