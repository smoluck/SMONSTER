# python
"""
Name:         SMO_CAD_RebuildPolyStripNormalizedWidth_Cmd.py
...
Purpose:      This script is designed to:
              ...
              The Middle Edge will be used to create an in between Width
              with a regular size all across the ring.
...
Cmd_Name = "smo.CAD.RebuildPolyStripNormalizedWidth"
# smo.CAD.RebuildPolyStripNormalizedWidth


class SMO_CAD_RebuildPolyStripNormalizedWidth_Cmd(lxu.command.BasicCommand):
    def __init__(self):
    ...
    def basic_Execute(self, msg, flags):
        ...
        if not self.dyna_IsSet(0):
            ...
            try:
                ...
                lx.eval('user.def Count dialogname "SMO CAD - Rebuild Polystrip (Normalized Witdh)"')
        ...
        lx.out('End of SMO_CAD_RebuildPolyStripNormalizedWidth Script')
        # ---------------- Compare TotalSafetyCheck value and decide or not to continue the process  --- END


lx.bless(SMO_CAD_RebuildPolyStripNormalizedWidth_Cmd, Cmd_Name)
