...
Command_Name = "smo.QT.SetMatColorIDByMeshIslands"
...
class SMO_QT_SetMatColorID_ByMeshIslands_Cmd(lxu.command.BasicCommand):
    def __init__(self):
...
lx.bless(SMO_QT_SetMatColorID_ByMeshIslands_Cmd, Command_Name)