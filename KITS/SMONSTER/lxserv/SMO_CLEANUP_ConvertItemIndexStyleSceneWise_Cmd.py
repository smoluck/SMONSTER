...
Command_Name = "smo.CLEANUP.ConvertItemIndexStyleSceneWise"
...
class SMO_Cleanup_ConvertItemIndexStyleSceneWise_Cmd(lxu.command.BasicCommand):
    ...
    def cmd_UserName (self):
        return 'SMO Cleanup ConvertItemIndexStyleSceneWise'
...
lx.bless(SMO_Cleanup_ConvertItemIndexStyleSceneWise_Cmd, Command_Name)