...
class SMO_UV_UnwrapRectangleOrient_Cmd(lxu.command.BasicCommand):
    ...
    def basic_Execute(self, msg, flags):
        ...
        TotalSafetyCheck = (SMO_SafetyCheck_UVUnwrapRectOri_Only1MeshItemSelected + SMO_SafetyCheckUVUnwrapSmart_PolygonModeEnabled + SMO_SafetyCheck_UVUnwrapRectOri_min1PolygonSelected)
